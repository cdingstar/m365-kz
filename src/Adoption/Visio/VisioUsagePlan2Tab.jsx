...
const VisioUsagePlan2Tab = () => {
  ...
  // Visio Plan 2 App Summary Usage by User 数据
  ...
  // Visio Plan 2 App Summary Detail 数据
  const appDetailData = [
    { userId: '0dd552621a9eaf9d45d89bc372292cd8ddd908f', userCount: 1, lastSigninDays: 1, app: 'Microsoft Visio Plan 2', pbiUserAssigned: 2 },
    { userId: '193a88f139039254246c6b2472aff5c059c693b4', userCount: 1, lastSigninDays: 1, app: 'Microsoft Visio Plan 2', pbiUserAssigned: 1 },
    { userId: '1a1ac37c6620f4961559b46f427092428796437', userCount: 1, lastSigninDays: 1, app: 'Microsoft Visio Plan 2', pbiUserAssigned: 2 },
    { userId: '4fcad4802620c25dd1471dc11d887fb521bc3b1', userCount: 1, lastSigninDays: 1, app: 'Microsoft Visio Plan 2', pbiUserAssigned: 2 },
    { userId: '571710b20467afcc1a4f4d1acafb6dd6f39ad806', userCount: 1, lastSigninDays: 1, app: 'Microsoft Visio Plan 2', pbiUserAssigned: 1 },
    { userId: '9de963cc329a626083d34a26c6766cdc7a1d37a4', userCount: 1, lastSigninDays: 1, app: 'Microsoft Visio Plan 2', pbiUserAssigned: 1 }
  ];

  // Visio Plan 2 App Usage 数据
  const appUsageData = [
  ...
  // Assigned Visio Plan 2 Capable Licenses to App Users 数据
  const licenseData = [
  ...
  return (
    <div className="p-6 bg-gray-900 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-gray-800 rounded-lg shadow-lg p-6">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="text-gray-400 text-sm mb-1">Assigned Visio Plan 2 Capable Licenses</h3>
        ...
        <div className="bg-gray-800 rounded-lg shadow-lg p-6">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="text-gray-400 text-sm mb-1">Visio Plan 2 Capable Users</h3>
        ...
        <div className="bg-gray-800 rounded-lg shadow-lg p-6">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="text-gray-400 text-sm mb-1">Visio Plan 2 App Users</h3>
        ...
        <div className="bg-gray-800 rounded-lg shadow-lg p-6">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="text-gray-400 text-sm mb-1">Visio Plan 2 User Utilisation</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        {/* Visio Plan 2 App Usage */}
        <div className="bg-gray-800 rounded-lg shadow-lg p-6">
          <h2 className="text-xl font-semibold text-white mb-4">Visio Plan 2 App Usage</h2>
        ...
        {/* Assigned Visio Plan 2 Capable Licenses to App Users */}
        <div className="bg-gray-800 rounded-lg shadow-lg p-6">
          <h2 className="text-xl font-semibold text-white mb-4">Assigned Visio Plan 2 Capable Licenses to App Users</h2>
          <div className="h-64 bg-gray-700 rounded-lg p-4 relative">
      ...
      {/* 用户摘要和应用详情部分 - 移动到顶部 */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        {/* 左侧：Visio Plan 2 App Summary Usage by User */}
        <div className="bg-gray-800 rounded-lg shadow-lg overflow-hidden">
          <div className="p-4 border-b border-gray-700">
            <h2 className="text-xl font-semibold text-white">Visio Plan 2 App Summary Usage by User</h2>
          </div>
          <div className="overflow-x-auto">
            <table className="min-w-full">
              <thead className="bg-gray-700">
                <tr>
                  <th className="px-4 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">User using Visio Plan 2 Apps (Auth to Visio Plan 2)</th>
        ...
        {/* 右侧：Visio Plan 2 App Summary Detail */}
        <div className="bg-gray-800 rounded-lg shadow-lg overflow-hidden">
          <div className="p-4 border-b border-gray-700">
            <h2 className="text-xl font-semibold text-white">Visio Plan 2 App Summary Detail</h2>
          </div>
          <div className="overflow-x-auto">
            <table className="min-w-full">
              <thead className="bg-gray-700">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Visio Plan 2 User Assigned License count</th>
                </tr>
              </thead>
              <tbody className="bg-gray-800 divide-y divide-gray-700">
