...
const ProjectUsagePlan1Tab = () => {
  ...
  // Project Plan 1 App Summary Usage by User 数据
  ...
  // Project Plan 1 App Summary Detail 数据
  const appDetailData = [
  ...
  // Assigned Project Plan 1 Capable Licenses to App Users 数据
  const licenseData = [
  ...
  return (
    <div className="p-6 bg-gray-900 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-gray-800 rounded-lg shadow-lg p-6">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="text-gray-400 text-sm mb-1">Assigned Project Plan 1 Capable Licenses</h3>
        ...
        <div className="bg-gray-800 rounded-lg shadow-lg p-6">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="text-gray-400 text-sm mb-1">Project Plan 1 Capable Users</h3>
        ...
        <div className="bg-gray-800 rounded-lg shadow-lg p-6">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="text-gray-400 text-sm mb-1">Project Plan 1 App Users</h3>
        ...
        <div className="bg-gray-800 rounded-lg shadow-lg p-6">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="text-gray-400 text-sm mb-1">Project Plan 1 User Utilisation</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        {/* Project Plan 1 App Usage */}
        <div className="bg-gray-800 rounded-lg shadow-lg p-6">
          <h2 className="text-xl font-semibold text-white mb-4">Project Plan 1 App Usage</h2>
        ...
        {/* Assigned Project Plan 1 Capable Licenses to App Users */}
        <div className="bg-gray-800 rounded-lg shadow-lg p-6">
          <h2 className="text-xl font-semibold text-white mb-4">Assigned Project Plan 1 Capable Licenses to App Users</h2>
          <div className="h-64 bg-gray-700 rounded-lg p-4 relative">
      ...
      {/* 用户摘要和应用详情部分 - 移动到顶部 */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        {/* 左侧：Project Plan 1 App Summary Usage by User */}
        <div className="bg-gray-800 rounded-lg shadow-lg overflow-hidden">
          <div className="p-4 border-b border-gray-700">
            <h2 className="text-xl font-semibold text-white">Project Plan 1 App Summary Usage by User</h2>
          </div>
          <div className="overflow-x-auto">
            <table className="min-w-full">
              <thead className="bg-gray-700">
                <tr>
                  <th className="px-4 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">User using Project Plan 1 Apps (Auth to Project Plan 1)</th>
        ...
        {/* 右侧：Project Plan 1 App Summary Detail */}
        <div className="bg-gray-800 rounded-lg shadow-lg overflow-hidden">
          <div className="p-4 border-b border-gray-700">
            <h2 className="text-xl font-semibold text-white">Project Plan 1 App Summary Detail</h2>
          </div>
          <div className="overflow-x-auto">
            <table className="min-w-full">
              <thead className="bg-gray-700">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Project Plan 1 User Assigned License count</th>
                </tr>
              </thead>
              <tbody className="bg-gray-800 divide-y divide-gray-700">
